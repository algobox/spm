...
#define CLOCK_INIT  while(0) {}
#define CLOCK_START  while(0) {}
#define CLOCK_END while(0) {}
#define CLOCK_PRINT_SEC while(0) {}
...
uint8_t *BoyerMooreNocaseWrapper(uint8_t *text, uint8_t *in_needle, int times)
{
    ...
    uint8_t *needle = malloc(needlelen);
    if (needle == NULL)
        return NULL;
...
void TESTCALL(char *name, int(*TestFn)(void), int evalue)
{
    printf("\n#Enter [%s]\n", name);
...
{
    /* Generic tests */
    TESTCALL("UtilSpmBasicSearchTest01", UtilSpmBasicSearchTest01, 1);
    TESTCALL("UtilSpmBasicSearchNocaseTest01", UtilSpmBasicSearchNocaseTest01, 1);
    TESTCALL("UtilSpmBs2bmSearchTest01", UtilSpmBs2bmSearchTest01, 1);
    TESTCALL("UtilSpmBs2bmSearchNocaseTest01", UtilSpmBs2bmSearchNocaseTest01, 1);

    TESTCALL("UtilSpmBoyerMooreSearchTest01", UtilSpmBoyerMooreSearchTest01, 1);
    TESTCALL("UtilSpmBoyerMooreSearchNocaseTest01", UtilSpmBoyerMooreSearchNocaseTest01, 1);
    TESTCALL("UtilSpmBoyerMooreSearchNocaseTestIssue130", UtilSpmBoyerMooreSearchNocaseTestIssue130, 1);
    TESTCALL("UtilSpmBs2bmSearchTest02", UtilSpmBs2bmSearchTest02, 1);
    TESTCALL("UtilSpmBs2bmSearchNocaseTest02", UtilSpmBs2bmSearchNocaseTest02, 1);
    TESTCALL("UtilSpmBasicSearchTest02", UtilSpmBasicSearchTest02, 1);
    TESTCALL("UtilSpmBasicSearchNocaseTest02", UtilSpmBasicSearchNocaseTest02, 1);
    TESTCALL("UtilSpmBoyerMooreSearchTest02", UtilSpmBoyerMooreSearchTest02, 1);
    
    /* test matches at any offset */
    TESTCALL("UtilSpmBoyerMooreSearchNocaseTest02", UtilSpmBoyerMooreSearchNocaseTest02, 1);
    TESTCALL("UtilSpmSearchOffsetsTest01", UtilSpmSearchOffsetsTest01, 1);
    TESTCALL("UtilSpmSearchOffsetsNocaseTest01", UtilSpmSearchOffsetsNocaseTest01, 1);

    /* Give some stats searching given a prepared context (look at the wrappers) */
    TESTCALL("UtilSpmSearchStatsTest01", UtilSpmSearchStatsTest01, 1);
    TESTCALL("UtilSpmSearchStatsTest02", UtilSpmSearchStatsTest02, 1);
    TESTCALL("UtilSpmSearchStatsTest03", UtilSpmSearchStatsTest03, 1);

    TESTCALL("UtilSpmNocaseSearchStatsTest01", UtilSpmNocaseSearchStatsTest01, 1);
    TESTCALL("UtilSpmNocaseSearchStatsTest02", UtilSpmNocaseSearchStatsTest02, 1);
    TESTCALL("UtilSpmNocaseSearchStatsTest03", UtilSpmNocaseSearchStatsTest03, 1);

    /* Stats building context and searching */
    TESTCALL("UtilSpmSearchStatsTest04", UtilSpmSearchStatsTest04, 1);
    TESTCALL("UtilSpmSearchStatsTest05", UtilSpmSearchStatsTest05, 1);
    TESTCALL("UtilSpmSearchStatsTest06", UtilSpmSearchStatsTest06, 1);
    TESTCALL("UtilSpmSearchStatsTest07", UtilSpmSearchStatsTest07, 1);

    TESTCALL("UtilSpmNocaseSearchStatsTest04", UtilSpmNocaseSearchStatsTest04, 1);
    TESTCALL("UtilSpmNocaseSearchStatsTest05", UtilSpmNocaseSearchStatsTest05, 1);
    TESTCALL("UtilSpmNocaseSearchStatsTest06", UtilSpmNocaseSearchStatsTest06, 1);
    TESTCALL("UtilSpmNocaseSearchStatsTest07", UtilSpmNocaseSearchStatsTest07, 1);
